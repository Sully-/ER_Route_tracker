...
export type OAuthProvider = 'discord' | 'twitch' | 'google' | 'microsoft' | 'steam';
...
export const OAUTH_PROVIDERS: { id: OAuthProvider; name: string; color: string }[] = [
  { id: 'discord', name: 'Discord', color: '#5865F2' },
  { id: 'twitch', name: 'Twitch', color: '#9146FF' },
  { id: 'google', name: 'Google', color: '#4285F4' },
  // Microsoft et Steam désactivés pour l'instant (nécessitent config supplémentaire)
